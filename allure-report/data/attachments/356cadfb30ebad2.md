...
```yaml
- generic [ref=e4]: The Oracle Cloud Fusion Applications service you are trying to access is currently unavailable because the subscription renewal does not come in after the expiration grace period. Subsequent to suspension grace period if the renewal does not come in, the subscription termination will be initiated..
```
