...
Call log:
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <span class="xmv">Directory</span> from <div>…</div> subtree intercepts pointer events
  2 × retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
  ...
  - retrying click action
    - waiting 500ms
    - waiting for" https://fa-epvg-test-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/faces/FndOverview?fnd=%3B%3B%3B%3Bfalse%3B256%3B%3B%3B&fndGlobalItemNodeId=workforce_management_career_goals_responsive" navigation to finish...
    - navigated to "https://fa-epvg-test-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/faces/FndOverview?fnd=%3B%3B%3B%3Bfalse%3B256%3B%3B%3B&fndGlobalItemNodeId=workforce_management_career_goals_responsive"
    - waiting for element to be visible, enabled and stable
