...
- Location: tests\projectWorkSpaceERP\HCM\CoreHR\RehireAnEmployee.test.ts:7:5
...
- generic [ref=e7]:
  ...
  - main [ref=e15]:
    - main [ref=e16]:
      - main [ref=e18]:
        - generic [ref=e20]:
          - generic [ref=e23]: Enter the passcode sent to the mobile app on Trainee User's Phone-1 to continue.
          - textbox [active] [ref=e27]
          - button "Verify" [disabled] [ref=e30]:
            - generic [ref=e32]: Verify
          - button "Try another way" [ref=e35] [cursor=pointer]:
            - generic [ref=e37]: Try another way
```
